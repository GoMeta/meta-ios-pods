#
#  Be sure to run `pod spec lint GVRSDK-Wrapper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Sean Thielen"
  # s.authors            = { "Sean Thielen" => "sean@p27.us" }
  # s.social_media_url   = "http://twitter.com/Sean Thielen"
